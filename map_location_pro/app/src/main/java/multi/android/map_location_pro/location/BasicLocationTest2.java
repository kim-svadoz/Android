...
//위취정보를 제공하는 객체의 종류와현재 사용할 수 있는 위치정보 제공자를확인
//오류상황 !!! why??? avd에서 gps모듈을 제공하지 않는다.
//따라서 다른 Provider정보를 확인하고 사용할 수 있도록 작업.
...
public class BasicLocationTest2 extends AppCompatActivity implements LocationListener {
    ...
    List<String> enableProvider_list; // 사용가능한 위치 제공자 목록
    ...
    public void startLocationService(){
        //위치정보를 제공하는 제공자로부터 위치정보를 담고 있는 lOACTION 객체를 가져오기
        try{
