...
public class ActionBarTest extends AppCompatActivity {
    ...
    TextView result2;
    ListView listview;
    String[] datalist = {"java","hadoop","ice초코","String", "Apache", "SamgyupKKadugiGimbap", "flupe", "oracle"};
    @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //액션뷰로 설정되어 있는 뷰룰 추출한다.
        SearchView searchView = (androidx.appcompat.widget.SearchView) search_item.getActionView();
        //안내문구를 등록
