...
public class ExamAdapter2 extends ArrayAdapter<ActorItem> {
    ...
    public ExamAdapter2(Context context,
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        if(convertView==null){
            ...
            Log.d("firstjob","최초작업"+data.get(position).name+"====> convertView::::"
                    +convertView+":::::"+value);
        }
        ...
        if(actorItem!=null) {
           ...
           if(state ==null){
            ...
            Log.d("getview",actorItem.toString()+"**************"+convertView.getTag(R.string.app_name)
                    +"************"+convertView);
